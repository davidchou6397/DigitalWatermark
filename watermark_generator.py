...
def watermark():
    ...
    owner_img = cv2.imread('./static/owner_img.jpg', 0)
    
    for k in range(0, 7):
        master_img = cv2.imread('./static/master_images/master_img_'+str(k)+'.jpg', 0)
        ...
        cv2.imwrite('./static/regenerated_watermarks/watermark_img_'+str(k)+'.jpg', watermark_img)
        print k
    print "Done"
