...
def master():
    ...
    for cnt in range(0, 7):
        og_img = cv2.imread('/home/publicsw7_gmail_com/DigitalWatermark/static/stolen_images/stolen_image_'+str(cnt)+'.jpg',0)
        ...
        cv2.imwrite('./static/master_images/master_img_'+str(cnt)+'.jpg', master_img)
        print cnt
